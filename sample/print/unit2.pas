    ...
    begin
      case ComboZoom.ItemIndex of
        ...
        11: begin
              ...
              if h > ScrollBox.ClientHeight then
              begin
      ...
      l := 0;
      if w < ScrollBox.ClientWidth then
        l := (ScrollBox.ClientWidth - w) div 2;
      t := 0;
      if h < ScrollBox.ClientHeight then
        t := (ScrollBox.ClientHeight - h) div 2;
...
var
  p: TPoint;
begin
  p := Panel1.ClientToScreen(Point(ButtonPrint.Left, ButtonPrint.Top+ButtonPrint.Height));
  PMenu.Popup(p.X, p.Y);
end;
